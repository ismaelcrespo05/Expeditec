"""
Django settings for Expeditec project.
...
SECRET_KEY = 'django-insecure-16naaq%3%3*4v$*^$e40kke_48^kba&-zqhpidn$5p)(la!knk'
...
MIDDLEWARE = [
    ...
    'Login.middleware.SessionExpiredMiddleware',
...
WSGI_APPLICATION = 'Expeditec.wsgi.application'
